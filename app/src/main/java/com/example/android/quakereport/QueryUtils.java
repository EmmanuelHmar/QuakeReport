...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        Log.i("QueryUTils: ", " FETCHEARTHQUAKEDATA");
...
//            For each earthquake in the earthquakeArray, create {@link Earthquake) object
            for (int i = 0; i < earthquakeArray.length(); i++) {
//                Get a single earthquake at postiion i wihtin list of earthquakes
                JSONObject currentEarthquake = earthquakeArray.getJSONObject(i);

//                for a given earthquake, extract the jsonobject associated with it in key called "features"
