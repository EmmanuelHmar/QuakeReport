...
public final class QueryUtils {
    ...
    private static URL createUrl(String str) {
        ...
        try {
            ...
            Log.e("Error creating URL: ", e.getMessage());
        }
        return url;
    }
...
//        If URL is null, return
        ...
        InputStream inputStream= null;
            ...
            try {
                ...
                Log.d("QUERYUTILS CODE: ", ":: " + urlConnection.getResponseCode());
...
//    Read the inputStream and process it into a String using BufferedReader
